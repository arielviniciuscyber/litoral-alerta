        ...
        <div className="bg-white">
            ...
            <div className="max-w-5xl mx-auto px-8 py-16 flex gap-12 items-start">
                <div className="flex-1">
                    <h2 className="text-4xl font-bold text-gray-800 mb-9 mt-25">Sua proteção contra tempestades</h2>
                    <p className="text-gray-600 text-xl leading-relaxed">
                       Salvar vidas, aliviar o sofrimento e proteger a dignidade humana durante e após emergências e desastres.
                    </p>
                </div>
            ...
            <div className="max-w-4xl mx-auto px-8 py-12">
                ...
                <h3 className="text-4xl font-bold text-gray-800 mb-9 mt-15">1. Procure abrigo seguro imediatamente</h3>
                <div className="flex flex-col gap-3 mb-10 pl-4 text-xl">
                    <div className="flex items-start gap-3">
                        <span className="w-3 h-3 rounded-full bg-red-500 mt-9 shrink-0"></span>
                        <p className="text-black mt-6">O local mais seguro é dentro de uma construção protegida (casa, prédio) ou veículo fechado.</p>
                    </div>
                    <div className="flex items-start gap-3">
                        <span className="w-3 h-3 rounded-full bg-red-500 mt-3 shrink-0"></span>

                        <p className="text-black">Evite permanecer ao ar livre, especialmente em áreas abertas como campos, praias ou topo de morros.</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-3 mb-10 pl-4">
                    <div className="flex items-start gap-3 text-xl">
                        ...
                        <p className="text-black mt-9">Evite ficar perto de objetos metálicos, lugares úmidos, árvores isoladas, torres metálicas.</p>
                    </div>
                    <div className="flex items-start gap-3 text-xl">
                        <span className="w-3 h-3 rounded-full bg-red-500 mt-6 shrink-0"></span>
                        <p className="text-black mt-3">Não fique próximo de objetos que possam cair como árvores, postes, placas, antenas, estruturas frágeis, paredes e telhados.</p>
                    </div>
                </div>
            ...
            <div className="py-10 px-8 ">
                <h2 className="text-4xl font-bold text-4xl text-center tracking-wide mt-10">
            ...
            <div className="max-w-4xl mx-auto px-8 py-12 mt-10">
                ...
                <h3 className="text-3xl font-bold text-black mb-4">1. Retire objetos e estruturas que atraem raios</h3>
                <div className="flex flex-col gap-3 mb-10 pl-4">
                    <div className="flex items-start gap-3">
                        <span className="w-3 h-3 rounded-full bg-red-500 mt-11 shrink-0"></span>
                        <p className="text-black mt-9 text-xl">Retire do jardim, antenas e objetos soltos que possam ser arremessados pelo vento.</p>
                    </div>
                    <div className="flex items-start gap-3 mt-5">
                        <span className="w-3 h-3 rounded-full bg-red-500 mt-3 shrink-0"></span>
                        <p className="text-black text-xl">Não usar: Chuveiro ou torneiras (água conduz eletricidade), Telefones com fio Eletrodomésticos ligados à tomada.</p>
                    </div>
                    <div className="flex items-start gap-3 mt-5">
                        <span className="w-3 h-3 rounded-full bg-red-500 mt-3 shrink-0"></span>
                        <p className="text-black text-xl">Desconecte aparelhos elétricos desnecessários. Ative os para-raios e fusíveis corretamente.</p>
                    </div>
                </div>
...
<div style={{ textAlign: "center", marginTop: "32px", marginBottom: "32px" }}>
    <h1 className="text-3xl font-black text-center uppercase tracking-wide text-blue-950 mb-3">
        Como se proteger durante enchentes
    </h1>
    <div className="w-20 h-1 bg-red-600 mx-auto rounded" />
</div>
...
<div className="max-w-4xl mx-auto px-8 py-12">
    ...
    <div className="border border-blue-200 rounded-xl mb-6 overflow-hidden">
        <div className="flex items-center gap-4 px-6 py-4">
            <span className="bg-blue-950 text-white font-black text-lg w-9 h-9 flex items-center justify-center rounded-md">1</span>
            <h3 className="text-base font-black text-blue-950 uppercase tracking-wide">Evite áreas alagadas</h3>
        </div>
        <div className="flex flex-col gap-3 px-6 pb-5">
            <div className="flex items-center gap-4 border border-blue-100 rounded-lg p-3">
                ...
                <p className="text-gray-700 text-sm">Não trafegue com veículos por ruas alagadas — mesmo lâminas d'água rasas podem arrastar carros completamente.</p>
            </div>
            <div className="flex items-center gap-4 border border-blue-100 rounded-lg p-3">
                <div className="bg-red-600 rounded-full w-11 h-11 flex items-center justify-center text-xl shrink-0">🚶</div>
                <div className="w-0.5 h-10 bg-blue-100 shrink-0" />
                <p className="text-gray-700 text-sm">Nunca atravesse a pé. Pode ser extremamente perigoso mesmo em água aparentemente rasa.</p>
            </div>
        </div>
    </div>
    ...
    <div className="border border-blue-200 rounded-xl mb-6 overflow-hidden">
        <div className="flex items-center gap-4 px-6 py-4">
            <span className="bg-blue-950 text-white font-black text-lg w-9 h-9 flex items-center justify-center rounded-md">2</span>
            <h3 className="text-base font-black text-blue-950 uppercase tracking-wide">Busque locais altos</h3>
        </div>
        <div className="flex flex-col gap-3 px-6 pb-5">
            <div className="flex items-center gap-4 border border-blue-100 rounded-lg p-3">
                <div className="bg-blue-950 rounded-full w-11 h-11 flex items-center justify-center text-xl shrink-0">⬆️</div>
                <div className="w-0.5 h-10 bg-blue-100 shrink-0" />
                <p className="text-gray-700 text-sm">Se a água começar a subir dentro de casa, suba para andares superiores imediatamente.</p>
            </div>
            <div className="flex items-center gap-4 border border-blue-100 rounded-lg p-3">
                <div className="bg-blue-950 rounded-full w-11 h-11 flex items-center justify-center text-xl shrink-0">🪜</div>
                <div className="w-0.5 h-10 bg-blue-100 shrink-0" />
                <p className="text-gray-700 text-sm">Leve documentos importantes, remédios e água potável.</p>
            </div>
        </div>
    </div>
    ...
    <div className="bg-blue-950 rounded-xl p-5 flex items-center gap-4">
        ...
        <div>
            <p className="text-white font-black text-sm uppercase tracking-wide mb-1">Precisa de ajuda?</p>
            <p className="text-blue-200 text-sm">Em caso de emergência, ligue 199 (Defesa Civil) ou 193 (Corpo de Bombeiros).</p>
        </div>
    </div>
