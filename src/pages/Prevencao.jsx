                ...
                <div className="border border-blue-900 rounded-xl mb-30 overflow-hidden mt-15 pb-10 ">
                    ...
                    <div className="flex flex-col gap-3 px-6 pb-5 mt-7">
                        <div className="flex items-center gap-4 border border-blue-900 rounded-lg p-3">
                            <div className="bg-red-600 rounded-full w-11 h-11 flex items-center justify-center text-xl shrink-0 -translate-y-1">⚠️</div>
                            <div className="w-0.5 h-10 bg-blue-500 shrink-0" />
                            <p className="text-gray-900 text-xl">Não trafegue com veículos por ruas alagadas — mesmo lâminas d'água rasas podem arrastar carros completamente.</p>
                        </div>
                        <div className="flex items-center gap-4 border border-blue-900 rounded-lg p-3 mt-7">
                            ...
                            <div className="w-0.5 h-10 bg-blue-500 shrink-0" />
                            <p className="text-gray-900 text-xl">Nunca atravesse a pé. Pode ser extremamente perigoso mesmo em água aparentemente rasa.</p>
                        </div>
                    </div>
                </div>
