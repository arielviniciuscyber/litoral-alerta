export default function Home() {
  return (
    <div>
      ...
      >
        <div className="absolute inset-0 bg-black/50 flex flex-col justify-center px-10 text-white">
          <h1 className="text-3xl font-bold max-w-xl">
            Previsões aumentam o risco de chuvas fortes em 70% em
            Caraguatatuba 🚨
          </h1>
      ...
      {/* RESUMO */}
      <section className="max-w-4xl mx-auto mt-6 bg-white rounded-xl shadow p-6">
        ...
        <ul className="space-y-3 text-sm">
          ...
          <li>🔴 Resgates em Ubatuba após enchentes</li>
          <li>🔴 Deslizamentos deixam cidades em alerta</li>
          <li>🔴 Queda de árvores registrada</li>
        </ul>
